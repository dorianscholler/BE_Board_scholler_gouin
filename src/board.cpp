...
int main(){
  ...
  ExternalDigitalSensorButton digi1(DELAY,"bouton digital 1","1.txt");
  ExternalDigitalSensorButton digi2(DELAY,"bouton digital 2","2.txt");
  ExternalDigitalSensorButton digi3(DELAY,"bouton digital 3","3.txt");
  ExternalDigitalSensorButton digi4(DELAY,"bouton digital 4","4.txt");
  ExternalDigitalSensorButton digi5(DELAY,"bouton digital 5","5.txt");
  ExternalDigitalSensorButton digi6(DELAY,"bouton digital 6","6.txt");
  ExternalDigitalSensorButton digi7(DELAY,"bouton digital 7","7.txt");
  ExternalDigitalSensorButton digi8(DELAY,"bouton digital 8","8.txt");
